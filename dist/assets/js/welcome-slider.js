import{S as r,N as i,P as s}from"./pagination.js";function c(){const l=document.querySelectorAll(".slider-welcome__slide").length;function t(n){const e=(n+1).toString().padStart(2,"0"),o=l.toString().padStart(2,"0");document.querySelector(".counter").innerHTML=`
