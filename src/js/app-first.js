...
window.addEventListener('DOMContentLoaded', () => {
    ...
    sliderWelcome();//большой объем, нужно, чтобы не мешал загружать основные скрипты, а грузился потом

    sliderComparisonImages();//большой объем, нужно, чтобы не мешал загружать основные скрипты, а грузился потом

    customMainVideoPlayer();//большой объем, нужно, чтобы не мешал загружать основные скрипты, а грузился потом

    // Запускаем слайдер видео и сохраняем промис для управления из главного видео
    window.sliderVideoAPIInstance = sliderVideoAPI();//большой объем, нужно, чтобы не мешал загружать основные скрипты, а грузился потом
